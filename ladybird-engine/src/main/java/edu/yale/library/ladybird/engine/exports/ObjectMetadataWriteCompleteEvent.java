 ...
 */
public final class ObjectMetadataWriteCompleteEvent extends ExportEvent {
    ...
    public ObjectMetadataWriteCompleteEvent(User user, Spreadsheet spreadsheet, int rowsProcessed, int passCount,
