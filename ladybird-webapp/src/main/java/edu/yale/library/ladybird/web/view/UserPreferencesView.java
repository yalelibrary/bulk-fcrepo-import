...
public class UserPreferencesView extends AbstractView {
    ...
    public void updatePreferences() {
        ...
        userPreferences.setUserId(0); //TODO get from DB or session
    ...
    private int getProjectId(final Project defaultProject) {
        ...
        return projectList.get(0).getProjectId(); //TODO only one project anyway
    }
    ...
    private int getUserId(final String netid) {
        ...
        return userList.get(0).getUserId(); //TODO only one project anyway
    }
