package edu.yale.library.ladybird.kernel.persistence;
...
public class HibernateUtilTest {
     ...
     *
     * @throws Exception
     * @see edu.yale.library.ladybird.kernel.persistence.HibernateUtil.ConfigReader
     */
    @Test
    public void assertGetConfigFileMapping() throws Exception {
        Class<?> innerClass = Class.forName("edu.yale.library.ladybird.kernel.persistence.HibernateUtil$ConfigReader");
        Constructor<?> constructor = innerClass.getDeclaredConstructor(edu.yale.library.ladybird.kernel.persistence.HibernateUtil.class);
