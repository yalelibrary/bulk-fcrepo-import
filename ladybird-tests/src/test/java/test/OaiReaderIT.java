...
{
    private final static Logger logger = getLogger(OaiReaderIT.class);
    private final static String DC_OAI_PROVIDER = "http://columbus.library.yale.edu:8055/OAI_Orbis"
            + "/src/OAIOrbisTool.jsp?verb=GetRecord&identifier=oai:orbis.library.yale.edu:6915810&metadataPrefix=oai_dc";
    private final static String MARC_OAI_PROVIDER = getMarcString();
